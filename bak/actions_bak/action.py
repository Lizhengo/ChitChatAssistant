...
class TripForm(FormAction):
    ...
    def required_slots(tracker: Tracker) -> List[Text]:
        ...
        return ["trip_date_time", "trip_address"]
    ...
    def submit(
        ...
        """Define what the form has to do
            after all required slots are filled"""
        address = tracker.get_slot('trip_address')
        date_time = tracker.get_slot('trip_date_time')
        dispatcher.utter_message(text="你要申请{}去{}的差旅".format(date_time, address))
        return []
